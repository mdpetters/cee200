...
# ╔═╡ 52fd171d-43f3-451a-b689-ce6302f0e0ab
...
# ╔═╡ 532dc9c2-e3fd-4bfe-b837-48e10a520923
@syms n::(integer,positive)=>"true"

# ╔═╡ e8e6cac1-ac65-448a-8cd6-07f773887cb9
 A = sympy.MatrixSymbol("A", n, n)

# ╔═╡ c1c27cc8-b82c-42f4-abec-98d80f1ddbf2
l = sympy.MatrixSymbol("l", n, 1)

# ╔═╡ dd4c7dc6-85bd-4e55-9526-76b67b2f1452
h = sympy.MatrixSymbol("h", n, 1)

# ╔═╡ 4ae8d6c0-4bae-48c7-9bfb-fc6dc048fc49
eq = A*l - h

# ╔═╡ 032188a3-310e-413e-9502-6f497afbfd6d
eq10 = transpose(eq)*eq

# ╔═╡ ec90a82e-a922-45bf-90c5-9d2f5fabe1a0
eq100 = diff(eq10, h)

# ╔═╡ 35eacb2d-f3a4-4e1a-8106-517b8cbe571b
#solve(aeq100, l)
